    ...
    async def help(self, ctx, arg=None):
        if arg is None:
            help_embed = discord.Embed(
                title="Le-ptit-bot", color=0xD6C18A
            )  # vous pouvez changer le colour
            help_embed.add_field(name="```--```", value="le préfixe", inline=False)
