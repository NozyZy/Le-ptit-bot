...
class Tag(object):
    ...
    def __eq__(self, other):
        ...
        return ((self.platform == other.platform) and (self.abi == other.abi)
...
def _is_manylinux_compatible(name, arch, glibc_version):
    ...
    try:
        ...
        if hasattr(_manylinux, "manylinux_compatible"):
            result = _manylinux.manylinux_compatible(glibc_version[0],
                                                     glibc_version[1], arch)
...
class _ELFFileHeader(object):
    ...
    def __init__(self, file):
        ...
        def unpack(fmt):
            # type: (str) -> int
            try:
                (result, ) = struct.unpack(fmt, file.read(
                    struct.calcsize(fmt)))  # type: (int, )
            except struct.error:
