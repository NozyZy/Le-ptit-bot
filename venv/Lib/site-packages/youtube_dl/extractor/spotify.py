...
class SpotifyBaseIE(InfoExtractor):
    ...
    _OPERATION_HASHES = {
        "Episode":
        "8276d4423d709ae9b68ec1b74cc047ba0f7479059a37820be730f125189ac2bf",
        "MinimalShow":
        "13ee079672fad3f858ea45a55eb109553b4fb0969ed793185b2e34cbb6ee7cc0",
        "ShowEpisodes":
    ...
    def _extract_episode(self, episode, series):
        ...
        if audio_preview_url:
            f = {
                "url":
                audio_preview_url.replace("://p.scdn.co/mp3-preview/",
            ...
            if audio_preview_format:
                ...
                mobj = re.match(r"([0-9A-Z]{3})_(?:[A-Z]+_)?(\d+)",
...
class SpotifyIE(SpotifyBaseIE):
    ...
    def _real_extract(self, url):
        ...
        episode = self._call_api(
            "Episode", episode_id,
            {"uri": "spotify:episode:" + episode_id})["episode"]
...
class SpotifyShowIE(SpotifyBaseIE):
    ...
    def _real_extract(self, url):
        ...
        return self.playlist_result(entries, show_id, podcast_name,
