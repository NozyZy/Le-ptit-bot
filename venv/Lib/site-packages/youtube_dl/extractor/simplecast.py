...
class SimplecastBaseIE(InfoExtractor):
    ...
    def _call_api(self, path_tmpl, video_id):
        return self._download_json(self._API_BASE + path_tmpl % video_id,
                                   video_id)
    ...
    def _parse_episode(self, episode):
        ...
        audio_file_url = (audio_file.get("url")
        ...
        return {
            ...
            title,
            "url":
            clean_podcast_url(audio_file_url),
            "webpage_url":
            webpage_url,
            "channel_url":
            channel_url,
            "series":
            try_get(episode, lambda x: x["podcast"]["title"]),
            "season_number":
            int_or_none(season.get("number")),
            "season_id":
            season_id,
            "thumbnail":
            ...
            episode_id,
            "episode_number":
            int_or_none(episode.get("number")),
            "description":
            strip_or_none(episode.get("description")),
            "timestamp":
            parse_iso8601(episode.get("published_at")),
            "duration":
            int_or_none(episode.get("duration")),
            "filesize":
            int_or_none(
...
class SimplecastIE(SimplecastBaseIE):
    ...
    _COMMON_TEST_INFO = {
        ...
        "webpage_url":
        r"re:^https?://the-re-bind-io-podcast\.simplecast\.com/episodes/errant-signal-chris-franklin-new-wave-video-essays",
        "channel_url":
        r"re:^https?://the-re-bind-io-podcast\.simplecast\.com$",
    }
    _TESTS = [
        {
            "url":
        ...
        {
            "url":
            "https://player.simplecast.com/b6dc49a2-9404-4853-9aa9-9cfc097be876",
            "only_matching": True,
        },
    ]
...
class SimplecastEpisodeIE(SimplecastBaseIE):
    ...
    _TEST = {
        "url":
        "https://the-re-bind-io-podcast.simplecast.com/episodes/errant-signal-chris-franklin-new-wave-video-essays",
        "md5": "8c93be7be54251bf29ee97464eabe61c",
    ...
    def _real_extract(self, url):
        ...
        episode = self._call_search_api("episode", mobj.group(1),
                                        mobj.group(0))
        return self._parse_episode(episode)
