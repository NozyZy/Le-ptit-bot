...
class StoryFireBaseIE(InfoExtractor):
    ...
    def _parse_video(self, video):
        ...
        return {
            ...
            # 'formats': formats,
            "thumbnail":
            video.get("storyImage"),
            "view_count":
            int_or_none(video.get("views")),
            "like_count":
            int_or_none(video.get("likesCount")),
            "comment_count":
            int_or_none(video.get("commentsCount")),
            "duration":
            int_or_none(video.get("videoDuration")),
            "timestamp":
            int_or_none(video.get("publishDate")),
            "uploader":
            video.get("username"),
            "uploader_id":
            uploader_id,
            ...
            uploader_id if uploader_id else None,
            "episode_number":
            int_or_none(
...
class StoryFireIE(StoryFireBaseIE):
    ...
    def _real_extract(self, url):
        ...
        video = self._call_api("generic/video-detail", video_id,
                               "video")["video"]
...
class StoryFireSeriesIE(StoryFireBaseIE):
    ...
    _TESTS = [
        {
            "url":
            "https://storyfire.com/write/series/stories/-Lq6MsuIHLODO6d2dDkr/",
            "info_dict": {
        ...
        {
            "url":
            "https://storyfire.com/write/series/stories/the_mortal_one/",
            "info_dict": {
                "id": "the_mortal_one",
            },
            "playlist_count": 0,
